...
set -gx GOROOT /opt/homebrew/Cellar/go/1.19.5/libexec
set -gx GOPRIVATE github.com/blackbird-plc
set -gx  XDG_CONFIG_HOME "$HOME/.config"
set -gx  BAT_THEME "Catpuccin-mocha"
...
# git gpg commit signing Blackbird.video configuration
set GPG_TTY $(tty)
gpgconf --launch gpg-agent

starship init fish | source

source /Users/h.fretwell/.config/op/plugins.sh
